...
function ActiveCard() {
  ...
  // Không dùng biến state để đóng mở modal nữa vì sẽ check isShowModalActiveCard ben activeCardSlice
  ...
  // Function dùng chung cho các trường hợp update card title, des, cover, comment,...vv
  const callApiUpdateCard = async (updateData) => {
    const updatedCard = await updateCardDetailsAPI(activeCard._id, updateData);
    // B1 : CẬp nhật lại cái card đang active trong modal hiện tại
    dispatch(updateCurrentActiveCard(updatedCard));
    // B2 : Cập nhật lại 1 cái bản ghi card trong cái activeBoard (nested data)
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction="column" spacing={1}>
              ...
              {/* Nếu user hiện tại đang đăng nhập chưa là thành viên của card thì mới hiện nút join */}
              {/* Khi click vào join sẽ luôn là hành động ADD */}
