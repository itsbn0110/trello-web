export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'BaoNgoDev Trello Project',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://user-images.githubusercontent.com/74038190/225813708-98b745f2-7d22-48cf-9150-083f1b00d6c9.gif',
      ...
      },
      {
        ...
        /*
          ...
          Phía FE sẽ tự tạo ra một cái card đặc biệt: Placeholder Card, không liên quan gì đến BE
          Card đặc biệt này sẽ được ẩn ở giao diện người dùng
          Cấu tríc Od cỉa cáo card màu để Unique rất đơn giản, không caanf phải làm random phức tạp:
          "column-Id-placeholder-card" (mỗi column chỉ có thể có tối đa một cái Placeholder Card)
